...
- Implementing simulation methods for *a priori* power calculation from scratch is very revealing, because they make it very obvious how much we need to know to arrive at a sensible answer.
...
- if the true data generating process is drawing from Poisson distributions.
